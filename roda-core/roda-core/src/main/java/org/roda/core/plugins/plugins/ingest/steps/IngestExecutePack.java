...
public class IngestExecutePack {
  ...
  public IngestExecutePack(Plugin<?> ingestPlugin, IndexService index, ModelService model, StorageService storage,
    IngestJobPluginInfo jobPluginInfo, PluginParameter pluginParameter, Map<String, String> parameterValues,
    List<TransferredResource> resources, List<AIP> aips) {
